...
exports.getBatchActualPosition = (req, res, next) => {
  ...
  sql = `WITH PART_NBR_OLD AS
         ...
         SELECT A.APPID, A.PROCESSINGSTATUS, A.PRODUCTNAME, G.MAGNITUDE AS OLD_PART_TYPE, A.PLANNAME, A.COMPONENTQTY,
              A.VENDORLOTID, A.VENDORID, C.STEPNAME, C.HANDLE, C.LOCATION, C.PROCESSINGSTATE, F.RULENAME, C.TIMEHERESINCE
